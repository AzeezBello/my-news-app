      ...
      <div className="container mx-auto flex justify-between items-center px-4">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center">
            <img src="http://127.0.0.1:8000/media/images/logo.png" alt="Logo" className="h-8 mr-2 cursor-pointer" />
          ...
          <nav className="flex space-x-6 text-gray-800 font-medium">
            ...
            <div className="relative">
              ...
              {isFeedDropdownOpen && (
                ...
                >
                  <Link href="/news/saved" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Saved News</Link>
                  <Link href="/news/custom" className="block px-4 py-2 text-gray-700 hover:bg-gray-100">Custom News</Link>
                </div>
              )}
            </div>

            <Link href="/news/lopsided" className="hover:underline relative group">
              Lopsided
              <div className="h-0.5 bg-black mt-1 absolute bottom-0 left-0 right-0 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
            </Link>
            <Link href="/news/local" className="hover:underline relative group">
              Local News
              <div className="h-0.5 bg-black mt-1 absolute bottom-0 left-0 right-0 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
            </Link>
            <Link href="/about" className="hover:underline relative group">
              Timelines
              <div className="h-0.5 bg-black mt-1 absolute bottom-0 left-0 right-0 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>
            </Link>
          </nav>
